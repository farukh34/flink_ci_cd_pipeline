...
SET pipeline.name=3c36bc68_edr_batch03;
...
SELECT 
  JSON_OBJECT ('event' VALUE JSON_OBJECT('host' VALUE `host`.`name`, 'uuid' VALUE `uuid`, 'created' VALUE `event`.`created`, 'code' VALUE `event`.`code`),
       ...
       'rule' VALUE JSON_OBJECT('id' VALUE '2c583ef5-4b0b-48bf-8503-add81bcb9b04', 'name' VALUE 'WMI Event Subscription_clone', 'description' VALUE 'Detects creation of WMI event subscription persistence method'),
...
SELECT 
  JSON_OBJECT ('event' VALUE JSON_OBJECT('host' VALUE `host`.`name`, 'uuid' VALUE `uuid`, 'created' VALUE `event`.`created`, 'code' VALUE `event`.`code`),
       ...
       'uuid' VALUE UUID(),
       'alert' VALUE JSON_OBJECT('created' VALUE now(), 'kind' VALUE 'alert', 'level' VALUE 'medium'),
       'rule' VALUE JSON_OBJECT('id' VALUE '85a338d0-badd-4e67-a83b-fc3a546673e4', 'name' VALUE 'WMI Event Subscription_clone_clone', 'description' VALUE 'Detects creation of WMI event subscription persistence method'),
       'observables_list' VALUE ARRAY['NA'],
       'falsepositives' VALUE ARRAY['Exclude legitimate (vetted) use of WMI event subscription in your network'] ,
       'tacticidlist' VALUE ARRAY['TA0003'],
       'techniqueidlist' VALUE ARRAY['T1546.003']
