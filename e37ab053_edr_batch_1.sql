...
WITH (
  'connector' = 'kafka',
  'topic' = 'edr',
  'properties.bootstrap.servers' = '10.132.130.134:9092,10.132.142.162:9092,10.132.132.145:9092',
...
BEGIN
insert into FlinkOut SELECTSELECT 
  JSON_OBJECT ('event' VALUE JSON_OBJECT('host' VALUE `host`.`name`, 'uuid' VALUE `uuid`, 'created' VALUE `event`.`created`, 'code' VALUE `event`.`code`),
       ...
       'rule' VALUE JSON_OBJECT('id' VALUE '918c8c85-d115-42dc-8781-048aa1865f2f', 'name' VALUE 'WMI Event Subscription_custom', 'description' VALUE 'Detects creation of WMI event subscription persistence method'),
  ...
  )) FROM stream_edr WHERE (`organization`.`id`='e37ab053') AND ((REGEXP_EXTRACT(cast(`EventID` as VARCHAR), '^19$') is not null OR REGEXP_EXTRACT(cast(`EventID` as VARCHAR), '^20$') is not null OR REGEXP_EXTRACT(cast(`EventID` as VARCHAR), '^21$') is not null) )
insert into FlinkOut SELECT
  JSON_OBJECT ('event' VALUE JSON_OBJECT('host' VALUE `host`.`name`, 'uuid' VALUE `uuid`, 'created' VALUE `event`.`created`, 'code' VALUE `event`.`code`),
       ...
       'uuid' VALUE UUID(),
       'alert' VALUE JSON_OBJECT('created' VALUE now(), 'kind' VALUE 'alert', 'level' VALUE 'medium'),
       'rule' VALUE JSON_OBJECT('id' VALUE 'faf9b6b6-ee41-4f7f-9c2e-5d66beed3f9b', 'name' VALUE 'WMI Event Subscription_custom_clone', 'description' VALUE 'Detects creation of WMI event subscription persistence method'),
       'observables_list' VALUE ARRAY['NA'],
       'falsepositives' VALUE ARRAY['Exclude legitimate (vetted) use of WMI event subscription in your network'] ,
       'tacticidlist' VALUE ARRAY['TA0003'],
       'techniqueidlist' VALUE ARRAY['T1546.003']
...
insert into FlinkOut SELECT
  JSON_OBJECT ('event' VALUE JSON_OBJECT('host' VALUE `host`.`name`, 'uuid' VALUE `uuid`, 'created' VALUE `event`.`created`, 'code' VALUE `event`.`code`),
       ...
       'uuid' VALUE UUID(),
       'alert' VALUE JSON_OBJECT('created' VALUE now(), 'kind' VALUE 'alert', 'level' VALUE 'medium'),
       'rule' VALUE JSON_OBJECT('id' VALUE '2b8b11ea-0484-40bb-a9dd-d214bc6fab52', 'name' VALUE 'WMI Event Subscription_custom_clone_clone', 'description' VALUE 'Detects creation of WMI event subscription persistence method'),
       'observables_list' VALUE ARRAY['NA'],
       'falsepositives' VALUE ARRAY['Exclude legitimate (vetted) use of WMI event subscription in your network'] ,
       'tacticidlist' VALUE ARRAY['TA0003'],
       'techniqueidlist' VALUE ARRAY['T1546.003']
...
insert into FlinkOut SELECT
  JSON_OBJECT ('event' VALUE JSON_OBJECT('host' VALUE `host`.`name`, 'uuid' VALUE `uuid`, 'created' VALUE `event`.`created`, 'code' VALUE `event`.`code`),
       ...
       'uuid' VALUE UUID(),
       'alert' VALUE JSON_OBJECT('created' VALUE now(), 'kind' VALUE 'alert', 'level' VALUE 'medium'),
       'rule' VALUE JSON_OBJECT('id' VALUE 'd3b035c1-2521-4ba7-abdf-f69af54f7bf2', 'name' VALUE 'WMI Event Subscription_custom_clone_clone_clone', 'description' VALUE 'Detects creation of WMI event subscription persistence method'),
       'observables_list' VALUE ARRAY['NA'],
       'falsepositives' VALUE ARRAY['Exclude legitimate (vetted) use of WMI event subscription in your network'] ,
       'tacticidlist' VALUE ARRAY['TA0003'],
       'techniqueidlist' VALUE ARRAY['T1546.003']
...
insert into FlinkOut SELECT
  JSON_OBJECT ('event' VALUE JSON_OBJECT('host' VALUE `host`.`name`, 'uuid' VALUE `uuid`, 'created' VALUE `event`.`created`, 'code' VALUE `event`.`code`),
       ...
       'uuid' VALUE UUID(),
       'alert' VALUE JSON_OBJECT('created' VALUE now(), 'kind' VALUE 'alert', 'level' VALUE 'medium'),
       'rule' VALUE JSON_OBJECT('id' VALUE 'b03b5530-398a-4f08-b41c-25ad18d352a6', 'name' VALUE 'WMI Event Subscription_custom_clone_clone_clone_clone', 'description' VALUE 'Detects creation of WMI event subscription persistence method'),
       'observables_list' VALUE ARRAY['NA'],
       'falsepositives' VALUE ARRAY['Exclude legitimate (vetted) use of WMI event subscription in your network'] ,
       'tacticidlist' VALUE ARRAY['TA0003'],
       'techniqueidlist' VALUE ARRAY['T1546.003']
